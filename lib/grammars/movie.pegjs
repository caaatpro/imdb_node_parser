...
series
    = title:seriesTitle space* year:yearAndVersion space* format? space* suspended:suspended? space* running:runningPeriod
    {return {title: title, year: year.year, version: year.version, suspended:suspended, type:'series', running: running} }

movie
  =
    title:notAYearToken+ year:yearAndVersion space* format:format? space* suspended:suspended? space* ignoredInput*
  {
